...
return [
     ...
     */
    'configRepository'  => \App\FileManager\UserConfigRepository::class,
     ...
     */
    'aclRepository' => \App\FileManager\UserACLRepository::class,
     ...
     * [] - no restrictions
     */
    'allowFileTypes' => ['jpg','jpeg','png','gif','webp','svg','pdf','doc','docx','xls','xlsx','csv','mp4','webm','mp3','wav','zip','rar'],
